    ...
    public static GameConfig lerConfiguracaoTexto(String nomeArquivo)
        ...
        if (largura <= 0 || altura <= 0 || vidasPlayer <= 0) {
            throw new ValoresInvalidosException(
                    "Erro: Configuracoes com valores menores ou iguais a zero não são válidas.");
        }
